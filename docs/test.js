// forked from takumifukasawa's "[2015.11.21] three.js: 線でcubeを作る" http://jsdo.it/takumifukasawa/S2Bi
(function($, win, doc) {
	...
	Main.prototype.update = function() {
		for(var i=0, len=this.lines.length; i<len; i++) {
			//this.lines[i].geometry.setDrawRange(this.beginDrawPos*3, this.drawCount);
			this.lines[i].geometry.setDrawRange(this.drawCount, 10); // 始点, 個数
		...
		this.drawCount++;
		this.beginDrawPos = this.drawCount - 1;
